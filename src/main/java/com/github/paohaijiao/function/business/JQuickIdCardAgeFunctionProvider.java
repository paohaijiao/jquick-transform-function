...
public class JQuickIdCardAgeFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickIdCardAgeFunctionProvider() {
        super("idCardAge", "从身份证号计算年龄 - 用法: idCardAge(idCard, referenceDate?)");
    }
    ...
    public Object invoke(List<Object> args) {
        ...
        LocalDate reference = args.size() > 1 ? LocalDate.parse(args.get(1).toString()) : LocalDate.now();
