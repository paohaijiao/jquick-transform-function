...
public class JQuickBetweenInvoker extends JQuickBaseMethodInvoker {

    public JQuickBetweenInvoker() {
        super("between", "判断值是否在范围内 - 用法: between(value, min, max, inclusive?)");
    }
