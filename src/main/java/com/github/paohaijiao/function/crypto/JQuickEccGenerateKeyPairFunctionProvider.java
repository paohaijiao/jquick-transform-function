...
public class JQuickEccGenerateKeyPairFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickEccGenerateKeyPairFunctionProvider() {
        super("eccGenerateKeyPair", "[Crypto] ECC生成密钥对 - 用法: eccGenerateKeyPair() 返回包含公钥和私钥的Map");
    }
    ...
    public Object invoke(List<Object> args) {
        ...
        try {
            EccCryptoService service = new EccCryptoService();
