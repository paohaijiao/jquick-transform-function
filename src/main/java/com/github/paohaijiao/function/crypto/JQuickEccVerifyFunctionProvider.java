...
public class JQuickEccVerifyFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    private static final Map<String, EccCryptoService> serviceCache = new ConcurrentHashMap<>();

    public JQuickEccVerifyFunctionProvider() {
        super("eccVerify", "[Crypto] ECC验签 - 用法: eccVerify(data, signature, base64PublicKey)");
    }
