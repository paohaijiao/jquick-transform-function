...
public class JQuickStartOfYearFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickStartOfYearFunctionProvider() {
        super("startOfYear", "获取年份第一天 - 用法: startOfYear(date?)");
    }
