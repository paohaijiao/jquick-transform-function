...
public class JQuickYearsBetweenFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickYearsBetweenFunctionProvider() {
        super("yearsBetween", "计算两个日期之间的年份差 - 用法: yearsBetween(date1, date2)");
    }
