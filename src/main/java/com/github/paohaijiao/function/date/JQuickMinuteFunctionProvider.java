...
public class JQuickMinuteFunctionProvider extends JQuickBaseFunctionFunctionProvider {
    public JQuickMinuteFunctionProvider() {
        super("minute", "获取分钟(0-59) - 用法: minute(datetime?)");
    }
    @Override
