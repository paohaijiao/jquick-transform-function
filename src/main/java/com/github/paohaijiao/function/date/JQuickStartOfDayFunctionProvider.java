...
public class JQuickStartOfDayFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickStartOfDayFunctionProvider() {
        super("startOfDay", "获取日期开始时间(00:00:00) - 用法: startOfDay(date?)");
    }
