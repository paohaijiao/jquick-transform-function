...
public class JQuickDaysBetweenFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickDaysBetweenFunctionProvider() {
        super("daysBetween", "计算两个日期之间的天数差 - 用法: daysBetween(date1, date2)");
    }
