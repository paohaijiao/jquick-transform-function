...
public class JQuickEndOfMonthFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickEndOfMonthFunctionProvider() {
        super("endOfMonth", "获取月份最后一天 - 用法: endOfMonth(date?)");
    }
