...
public class JQuickIsBeforeFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickIsBeforeFunctionProvider() {
        super("isBefore", "判断日期是否在之前 - 用法: isBefore(date1, date2)");
    }
