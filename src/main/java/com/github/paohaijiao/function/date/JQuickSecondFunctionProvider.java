...
public class JQuickSecondFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickSecondFunctionProvider() {
        super("second", "获取秒(0-59) - 用法: second(datetime?)");
    }
