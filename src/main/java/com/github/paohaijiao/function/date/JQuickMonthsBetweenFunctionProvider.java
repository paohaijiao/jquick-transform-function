...
public class JQuickMonthsBetweenFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickMonthsBetweenFunctionProvider() {
        super("monthsBetween", "计算两个日期之间的月份差 - 用法: monthsBetween(date1, date2)");
    }
    ...
    public Object invoke(List<Object> args) {
        ...
        return Math.abs(ChronoUnit.MONTHS.between(d1, d2));
    }
