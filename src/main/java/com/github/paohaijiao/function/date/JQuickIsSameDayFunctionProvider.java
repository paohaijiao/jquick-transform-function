...
public class JQuickIsSameDayFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickIsSameDayFunctionProvider() {
        super("isSameDay", "判断两个日期是否为同一天 - 用法: isSameDay(date1, date2)");
    }
