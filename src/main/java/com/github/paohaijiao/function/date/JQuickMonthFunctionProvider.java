...
public class JQuickMonthFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickMonthFunctionProvider() {
        super("month", "获取月份(1-12) - 用法: month(date?)");
    }
