...
public class JQuickDayOfYearFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickDayOfYearFunctionProvider() {
        super("dayOfYear", "获取年中第几天(1-366) - 用法: dayOfYear(date?)");
    }
