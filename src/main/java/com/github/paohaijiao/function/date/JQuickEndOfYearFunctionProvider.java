...
public class JQuickEndOfYearFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickEndOfYearFunctionProvider() {
        super("endOfYear", "获取年份最后一天 - 用法: endOfYear(date?)");
    }
