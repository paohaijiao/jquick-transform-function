...
public class JQuickIsWeekendFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickIsWeekendFunctionProvider() {
        super("isWeekend", "判断是否为周末 - 用法: isWeekend(date?)");
    }
