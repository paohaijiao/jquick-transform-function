...
public class JQuickFibonacciFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickFibonacciFunctionProvider() {
        super("fibonacci", "计算斐波那契数 - 用法: fibonacci(n)");
    }
