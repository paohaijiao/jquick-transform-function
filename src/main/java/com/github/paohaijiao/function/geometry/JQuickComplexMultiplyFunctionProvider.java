...
public class JQuickComplexMultiplyFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickComplexMultiplyFunctionProvider() {
        super("complexMultiply", "复数乘法 - 用法: complexMultiply(r1, i1, r2, i2) 返回 [实部, 虚部]");
    }
