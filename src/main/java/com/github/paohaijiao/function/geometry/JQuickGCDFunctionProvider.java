...
public class JQuickGCDFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickGCDFunctionProvider() {
        super("gcd", "计算最大公约数 - 用法: gcd(a, b, ...)");
    }
    ...
    public Object invoke(List<Object> args) {
        ...
        for (int i = 1; i < args.size(); i++) {
            result = gcd(result, asLong(args.get(i)));
        }
        return result;
    }
