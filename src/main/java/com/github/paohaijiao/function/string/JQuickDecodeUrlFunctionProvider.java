...
public class JQuickDecodeUrlFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickDecodeUrlFunctionProvider() {
        super("decodeUrl", "URL解码 - 用法: decodeUrl(str)");
    }
