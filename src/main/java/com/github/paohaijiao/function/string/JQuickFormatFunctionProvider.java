...
public class JQuickFormatFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickFormatFunctionProvider() {
        super("format", "格式化字符串 - 用法: format(pattern, arg1, arg2, ...)");
    }
