...
public class JQuickRightPadFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickRightPadFunctionProvider() {
        super("rightPad", "右填充 - 用法: rightPad(str, size, padChar?)");
    }
