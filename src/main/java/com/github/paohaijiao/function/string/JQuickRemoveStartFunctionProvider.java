...
public class JQuickRemoveStartFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickRemoveStartFunctionProvider() {
        super("removeStart", "移除开头前缀 - 用法: removeStart(str, prefix, ignoreCase?)");
    }
    ...
    public Object invoke(List<Object> args) {
        ...
        String prefix = asString(args.get(1));
