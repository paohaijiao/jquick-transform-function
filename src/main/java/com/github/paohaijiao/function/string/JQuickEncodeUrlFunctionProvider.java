...
public class JQuickEncodeUrlFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickEncodeUrlFunctionProvider() {
        super("encodeUrl", "URL编码 - 用法: encodeUrl(str)");
    }
    @Override
