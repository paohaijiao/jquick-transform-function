...
public class JQuickLeftPadFunctionProvider extends JQuickBaseFunctionFunctionProvider {

    public JQuickLeftPadFunctionProvider() {
        super("leftPad", "左填充 - 用法: leftPad(str, size, padChar?)");
    }
